    ...
    messages: [
      {
        ...
        role: "user",
        content:
          "A boy runs across the shallow water with excitement and energy. Splashes rise around his feet as he moves quickly, creating ripples that spread across the surface. The sunlight reflects beautifully on the water, making the scene look bright and lively. A smile on his face shows his joy and freedom as he enjoys the moment surrounded by nature. The cool water and gentle breeze make the experience feel refreshing and unforgettable. A boy runs through the shallow water with excitement and happiness. Each step creates sparkling splashes that spread across the calm surface. The warm sunlight reflects on the water, making the scene look bright and peaceful. His cheerful smile and energetic movement show the joy of enjoying nature freely. Surrounded by green trees and fresh air, the moment feels adventurous and unforgettable, capturing the simple happiness of childhood.",
